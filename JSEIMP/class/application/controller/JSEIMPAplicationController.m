...
-(void)clickButton:(UIButton *)button{
    ...
    if (button.tag == 1) {
        ...
        JSEIMPGuanLiJiaShiCangController *guanLiJiaShiCangController = [JSEIMPGuanLiJiaShiCangController new];
        
        [self.navigationController pushViewController:guanLiJiaShiCangController animated:YES];
    }
}
