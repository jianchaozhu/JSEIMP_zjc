//
//  JSEIMPSureZhuanQianPersonController.m
//  JSEIMP
//
...
@interface JSEIMPSureZhuanQianPersonController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JSEIMPSureZhuanQianPersonController{
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *chaoSongButton = [[UIBarButtonItem alloc] initWithTitle:@"转签" style:UIBarButtonItemStylePlain target:self action:@selector(clickZhuanQianButton:)];
    
    NSArray *buttonArray = [NSArray arrayWithObjects:stopButton,chaoSongButton, nil];
...
-(void)clickZhuanQianButton:(UIButton *)button{
    ...
    NSLog(@"%@",_option);
    [JSEIMPNetWorking PostZhuanQianStepWithReason:_option ActivityInstanceId:_activityId TargetUsers:_targetUsersMArray OnSuccess:^{
