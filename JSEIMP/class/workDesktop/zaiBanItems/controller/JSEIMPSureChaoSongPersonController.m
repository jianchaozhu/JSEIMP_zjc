//
//  JSEIMPSureChaoSongPersonController.m
//  JSEIMP
//
...
@interface JSEIMPSureChaoSongPersonController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JSEIMPSureChaoSongPersonController{
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *chaoSongButton = [[UIBarButtonItem alloc] initWithTitle:@"抄送" style:UIBarButtonItemStylePlain target:self action:@selector(clickChaoSongButton:)];
...
-(void)clickChaoSongButton:(UIButton *)button{
