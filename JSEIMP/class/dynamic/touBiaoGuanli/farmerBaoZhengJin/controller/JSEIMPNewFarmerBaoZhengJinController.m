//
//  JSEIMPNewFarmerBaoZhengJinController.m
//  JSEIMP
//
...
@interface JSEIMPNewFarmerBaoZhengJinController ()<UITextFieldDelegate,UITextViewDelegate,LMJDropdownMenuDelegate>

@end

@implementation JSEIMPNewFarmerBaoZhengJinController{
