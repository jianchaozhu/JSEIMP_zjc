//
//  JSFarmerBaoZhengJinController.m
//  JSEIMP
//
...
#import "JSEIMPNewFarmerBaoZhengJinController.h"
#import "JSEIMPNetWorking.h"

static NSString *cellID = @"cellID";

@interface JSFarmerBaoZhengJinController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
...
@implementation JSFarmerBaoZhengJinController{
...
-(void)getData{
    ...
    [JSEIMPNetWorking getFarmerBaoZhengJinOnSuccess:^(NSMutableArray *depositAmountMArray,NSMutableArray *depositIdMArray,NSMutableArray *projectNameMArray){
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JSEIMPFarmerBaoZhengJinDetailController *farmerBaoZhengJinDetailController = [JSEIMPFarmerBaoZhengJinDetailController new];
    
    farmerBaoZhengJinDetailController.depositAmount = _depositAmountMArray[indexPath.row];
    farmerBaoZhengJinDetailController.depositId = _depositIdMArray[indexPath.row];
    farmerBaoZhengJinDetailController.projectName = _projectNameMArray[indexPath.row];
    
    [self.navigationController pushViewController:farmerBaoZhengJinDetailController animated:YES];
