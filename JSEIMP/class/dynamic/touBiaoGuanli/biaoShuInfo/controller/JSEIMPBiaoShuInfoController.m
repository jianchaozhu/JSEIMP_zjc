...
@interface JSEIMPBiaoShuInfoController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JSEIMPBiaoShuInfoController{
...
-(void)clickAddButton{
    ...
    JSEIMPNewBiaoShuInfoController *newBiaoShuInfoController = [JSEIMPNewBiaoShuInfoController new];
    
    [self.navigationController pushViewController:newBiaoShuInfoController animated:YES];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JSEIMPBiaoShuInfoDetailController *biaoShuInfoDetailController = [JSEIMPBiaoShuInfoDetailController new];
    
    biaoShuInfoDetailController.projectName = _projectNameMArray[indexPath.row];
    biaoShuInfoDetailController.guiMo = _guiMoMArray[indexPath.row];
    biaoShuInfoDetailController.ziJinLaiYuan = _ziJinLaiYuanMArray[indexPath.row];
    
    [self.navigationController pushViewController:biaoShuInfoDetailController animated:YES];
