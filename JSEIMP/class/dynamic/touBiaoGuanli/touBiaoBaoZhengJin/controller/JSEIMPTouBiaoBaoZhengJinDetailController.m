//
//  JSEIMPTouBiaoBaoZhengJinDetailController.m
//  JSEIMP
//
...
@interface JSEIMPTouBiaoBaoZhengJinDetailController ()
//建设单位
...
@implementation JSEIMPTouBiaoBaoZhengJinDetailController{
...
-(void)getData{
    ...
    [JSEIMPNetWorking getTouBiaoBaoZhengJinDetailWithDepositId:_depositId OnSuccess:^(NSString *buildCompany,NSString *finalJiaoNaDate,NSString *finalTuiKuanDate,NSString *jiaoNaAccount,NSString *finalIsZhongBiao,NSString *beiZhu){
