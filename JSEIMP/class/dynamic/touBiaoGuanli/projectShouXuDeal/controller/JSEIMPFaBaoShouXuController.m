...
@interface JSEIMPFaBaoShouXuController ()

@end

@implementation JSEIMPFaBaoShouXuController{
    ...
    UILabel *_faBaoNoteLabel;
    
    UILabel *_jiaoYiMoneyLabel;
...
-(void)setupUI{
    ...
    _label2 = [self setupLabelWithText:@"项目经理" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label3 = [self setupLabelWithText:@"发包完结时间" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label4 = [self setupLabelWithText:@"有无发包通知书" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label5 = [self setupLabelWithText:@"工程交易费(元)" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label6 = [self setupLabelWithText:@"备注" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _managerLabel = [self setupLabelWithText:@"谢帆" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _managerLabel.textAlignment = NSTextAlignmentRight;
    ...
    _faBaoNoteLabel = [self setupLabelWithText:@"有" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _faBaoNoteLabel.textAlignment = NSTextAlignmentRight;
    
    _jiaoYiMoneyLabel = [self setupLabelWithText:@"20000" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _jiaoYiMoneyLabel.textAlignment = NSTextAlignmentRight;
    ...
    [_endDateLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(_managerLabel.mas_right);
    ...
    [_faBaoNoteLabel mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_jiaoYiMoneyLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.centerY.mas_equalTo(_label5.mas_centerY);
        make.left.mas_equalTo(_label5.mas_right).offset(16);
        make.right.mas_equalTo(_faBaoNoteLabel.mas_right);
    ...
    [_beiZhuLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.mas_equalTo(_label6.mas_centerX);
