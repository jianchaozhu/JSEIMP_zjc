...
#define UIScreenW [UIScreen mainScreen].bounds.size.weight
#define UIScreenH [UIScreen mainScreen].bounds.size.height

@interface JSEIIMPNewHeTongBeiAnView ()<LMJDropdownMenuDelegate>

@end

@implementation JSEIIMPNewHeTongBeiAnView{
...
-(void)touchEvent{
    ...
    [_beiAnHeTongMenu hideDropDown];
    [_xieYiShuMenu hideDropDown];
...
-(void)setupUI{
    ...
    _label1 = [self setupLabelWithText:@"合同办理完结日期" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _endDateButton = [self setButtonWithColor:[UIColor whiteColor] Title:@"==请选择日期==" Tag:1];
    _label2 = [self setupLabelWithText:@"有无备案合同" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _beiAnHeTongMenu = [self setDropDownMenuWithFrame:CGRectMake(16, 139,  [UIScreen mainScreen].bounds.size.width - 32, 30) Title:@"==请选择==" Titles:@[@"有",@"无"]];
    _label3 = [self setupLabelWithText:@"有无协议书" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _xieYiShuMenu = [self setDropDownMenuWithFrame:CGRectMake(16, 222,  [UIScreen mainScreen].bounds.size.width - 32, 30) Title:@"==请选择==" Titles:@[@"有",@"无"]];
    _label4 = [self setupLabelWithText:@"合同备注" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
...
-(void)layoutSubviews{
    ...
    [_label3 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(_beiAnHeTongMenu.mas_bottom).offset(16);
        make.centerX.mas_equalTo(_beiAnHeTongMenu.mas_centerX);
        
    }];

    [_label4 mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.mas_equalTo(_xieYiShuMenu.mas_bottom).offset(16);
        make.centerX.mas_equalTo(_xieYiShuMenu.mas_centerX);
        
    }];
    [_beiZhuTextView mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.mas_equalTo(_label4.mas_bottom).offset(8);
        make.left.mas_equalTo(_xieYiShuMenu.mas_left);
        make.right.mas_equalTo(_xieYiShuMenu.mas_right);
