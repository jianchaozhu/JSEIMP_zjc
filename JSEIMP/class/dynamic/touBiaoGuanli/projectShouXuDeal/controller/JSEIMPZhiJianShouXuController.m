//
//  JSEIMPZhiJianShouXuController.m
//  JSEIMP
//
...
@interface JSEIMPZhiJianShouXuController ()

@end

@implementation JSEIMPZhiJianShouXuController{
...
-(void)setupUI{
    ...
    _label2= [self setupLabelWithText:@"质检完成时间" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label3= [self setupLabelWithText:@"有无质检通知书" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _zhiJianNoteLabel = [self setupLabelWithText:@"有" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _zhiJianNoteLabel.textAlignment = NSTextAlignmentRight;
    ...
    [_zhiJianNoteLabel mas_makeConstraints:^(MASConstraintMaker *make) {
