//
//  JSEIMPHeTongBeiAnShouXuController.m
//  JSEIMP
//
...
@interface JSEIMPHeTongBeiAnShouXuController ()

@end

@implementation JSEIMPHeTongBeiAnShouXuController{
    ...
    UILabel *_beiAnHeTongLabel;
    
    UILabel *_xieYiBookLabel;
...
-(void)setupUI{
    ...
    _label3 = [self setupLabelWithText:@"有无备案合同" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label4 = [self setupLabelWithText:@"有无协议书" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label5 = [self setupLabelWithText:@"备注" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _endDateLabel = [self setupLabelWithText:@"2017-05-08 00:00:00" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:15]];
    _endDateLabel.textAlignment = NSTextAlignmentRight;
    
    _beiAnHeTongLabel = [self setupLabelWithText:@"有" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _beiAnHeTongLabel.textAlignment = NSTextAlignmentRight;
    
    _xieYiBookLabel = [self setupLabelWithText:@"有" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _xieYiBookLabel.textAlignment = NSTextAlignmentRight;
    ...
    [_beiAnHeTongLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.centerY.mas_equalTo(_label3.mas_centerY);
        make.left.mas_equalTo(_endDateLabel.mas_left);
    ...
    [_xieYiBookLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.centerY.mas_equalTo(_label4.mas_centerY);
        make.left.mas_equalTo(_label4.mas_right).offset(16);
        make.right.mas_equalTo(_beiAnHeTongLabel.mas_right);
