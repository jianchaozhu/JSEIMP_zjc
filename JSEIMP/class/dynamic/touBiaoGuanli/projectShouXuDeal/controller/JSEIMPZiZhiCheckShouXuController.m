//
//  JSEIMPZiZhiCheckShouXuController.m
//  JSEIMP
//
...
@interface JSEIMPZiZhiCheckShouXuController ()

@end

@implementation JSEIMPZiZhiCheckShouXuController{
...
-(void)setupUI{
    ...
    _label2 = [self setupLabelWithText:@"完成时间" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    _label3 = [self setupLabelWithText:@"有无核查书" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _endDateLabel = [self setupLabelWithText:@"2017-05-15 00:00:00" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _endDateLabel.textAlignment = NSTextAlignmentRight;
    
    _checkBookLabel = [self setupLabelWithText:@"有" TextColor:[UIColor darkGrayColor] Font:[UIFont systemFontOfSize:16]];
    _checkBookLabel.textAlignment = NSTextAlignmentRight;
    ...
    [_checkBookLabel mas_makeConstraints:^(MASConstraintMaker *make) {
