//
//  JSEIMPNewShiGongXuKeZhengView.m
//  JSEIMP
//
...
@interface JSEIMPNewShiGongXuKeZhengView ()<LMJDropdownMenuDelegate>

@end

@implementation JSEIMPNewShiGongXuKeZhengView{
...
-(void)setupUI{
    ...
    _label1 = [self setupLabelWithText:@"许可证办理完结日期" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _label2 = [self setupLabelWithText:@"有无许可证" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _label3 = [self setupLabelWithText:@"许可证备注" Font:[UIFont systemFontOfSize:20] TextColor:[UIColor darkTextColor]];
    _endDateButton = [self setButtonWithColor:[UIColor whiteColor] Title:@"==请选择日期==" Tag:1];
    _xuKeZhengMenu = [self setDropDownMenuWithFrame:CGRectMake(16, 139, UIScreenW - 32, 30) Title:@"==请选择==" Titles:@[@"有",@"无"]];
    _beiZhuTextView = [self setupTextView];
    _beiZhuPlaceLabel = [self setupPlaceLabelWithText:@"请填写许可证备注的内容" Font:[UIFont systemFontOfSize:16]];
...
-(void)layoutSubviews{
    ...
    [_label3 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(_xuKeZhengMenu.mas_bottom).offset(16);
        make.centerX.mas_equalTo(_xuKeZhengMenu.mas_centerX);
        
    }];
    [_beiZhuTextView mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.mas_equalTo(_label3.mas_bottom).offset(8);
        make.left.mas_equalTo(_xuKeZhengMenu.mas_left);
        make.right.mas_equalTo(_xuKeZhengMenu.mas_right);
