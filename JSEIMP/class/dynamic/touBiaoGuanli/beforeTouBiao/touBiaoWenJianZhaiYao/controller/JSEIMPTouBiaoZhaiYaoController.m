//
//  JSEIMPTouBiaoZhaiYaoController.m
//  JSEIMP
//
...
@interface JSEIMPTouBiaoZhaiYaoController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>

@property(nonatomic,strong)NSMutableArray *projectNameMArray;

@property(nonatomic,strong)NSMutableArray *createTimeMArray;
...
@implementation JSEIMPTouBiaoZhaiYaoController{
...
- (void)viewDidLoad {
    ...
    _projectNameMArray = [NSMutableArray arrayWithObjects:@"太阳城一期二标",@"俞泾浦南、四平路西地块综合开发项目总包工程", nil];
    _createTimeMArray = [NSMutableArray arrayWithObjects:@"2017-09-26",@"2017-08-08", nil];
    
    NSString *string1 = @"创建日期:";
    NSString *string2;
    
    _finalMArray = [NSMutableArray array];
    for (int i = 0; i < _projectNameMArray.count; i++) {
        
        string2 = [string1 stringByAppendingString:_createTimeMArray[i]];
...
//-(void)clickAddButton{
//    
//    JSEIMPNewTouBiaoZhaiYaoController *newTouBiaoZhaiYaoController = [JSEIMPNewTouBiaoZhaiYaoController new];
//    
//    [self.navigationController pushViewController:newTouBiaoZhaiYaoController animated:YES];
//    
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JSEIMPTouBiaoZhaiYaoDetailController *touBiaoZhaiYaoDetailController = [JSEIMPTouBiaoZhaiYaoDetailController new];
    
    touBiaoZhaiYaoDetailController.projectName = _projectNameMArray[indexPath.row];
    touBiaoZhaiYaoDetailController.createTime = _createTimeMArray[indexPath.row];
    
    [self.navigationController pushViewController:touBiaoZhaiYaoDetailController animated:YES];
