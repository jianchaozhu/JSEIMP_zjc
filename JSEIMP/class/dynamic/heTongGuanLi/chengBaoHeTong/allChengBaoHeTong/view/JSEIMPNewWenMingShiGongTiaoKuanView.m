//
//  JSEIMPNewWenMingShiGongTiaoKuanView.m
//  JSEIMP
//
...
@implementation JSEIMPNewWenMingShiGongTiaoKuanView{
    
    UILabel *_label1;
    
    UILabel *_shiGongTiaoKuanPlaceLabel;
...
-(void)setupUI{
    ...
    _shiGongTiaoKuanTextView = [self setupTextView];
    _shiGongTiaoKuanPlaceLabel = [self setupPlaceLabelWithText:@"请填写文明施工条款" Font:[UIFont systemFontOfSize:16]];
    [_shiGongTiaoKuanTextView addSubview:_shiGongTiaoKuanPlaceLabel];
...
-(void)layoutSubviews{
    ...
    [_shiGongTiaoKuanTextView mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_shiGongTiaoKuanPlaceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.mas_equalTo(_shiGongTiaoKuanTextView.mas_top).offset(8);
        make.left.mas_equalTo(_shiGongTiaoKuanTextView.mas_left).offset(6);
