...
-(void)setNotification{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(otherTiaoKuan:) name:@"otherTiaoKuan" object:nil];
    
}

-(void)otherTiaoKuan:(NSNotification *)notification{
