//
//  JSEIMPAllChengBaoHeTongController.m
//  JSEIMP
//
...
#import "JSEIMPChengBaoHeTongDetailController.h"
#import "JSEIMPNewChengBaoHeTongController.h"
#import "JSEIMPNetWorking.h"

static NSString *cellID = @"cellID";

@interface JSEIMPAllChengBaoHeTongController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UIScrollViewDelegate>
...
@implementation JSEIMPAllChengBaoHeTongController{
...
-(void)getData{
    ...
    [JSEIMPNetWorking getAllChengBaoHeTongOnSuccess:^(NSMutableArray *contractIdMArray,NSMutableArray *contractNameMArray,NSMutableArray *statusMArray){
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JSEIMPChengBaoHeTongDetailController *chengBaoHeTongDetailController = [JSEIMPChengBaoHeTongDetailController new];
    
    chengBaoHeTongDetailController.contractName = _contractNameMArray[indexPath.row];
    chengBaoHeTongDetailController.status = _statusMArray[indexPath.row];
    chengBaoHeTongDetailController.contractId = _contractIdMArray[indexPath.row];
    
    [self.navigationController pushViewController:chengBaoHeTongDetailController animated:YES];
