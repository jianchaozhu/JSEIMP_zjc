...
@implementation JSEIMPNewOtherTiaoKuanView{
    
    UILabel *_label1;
    
    UILabel *_otherTiaoKuanPlaceLabel;
...
-(void)setupUI{
    ...
    _otherTiaoKuanTextView = [self setupTextView];
    _otherTiaoKuanPlaceLabel = [self setupPlaceLabelWithText:@"请填写其他条款" Font:[UIFont systemFontOfSize:16]];
    [_otherTiaoKuanTextView addSubview:_otherTiaoKuanPlaceLabel];
...
-(void)layoutSubviews{
    ...
    [_otherTiaoKuanTextView mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_otherTiaoKuanPlaceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.mas_equalTo(_otherTiaoKuanTextView.mas_top).offset(8);
        make.left.mas_equalTo(_otherTiaoKuanTextView.mas_left).offset(6);
