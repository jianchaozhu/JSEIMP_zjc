//
//  JSEIMPChildCaiGouHeTongController.m
//  JSEIMP
//
...
@interface JSEIMPChildCaiGouHeTongController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UIScrollViewDelegate>
...
@implementation JSEIMPChildCaiGouHeTongController{
...
-(void)getData{
    ...
    [JSEIMPNetWorking getCaiGouHeTongOnSuccess:^(NSMutableArray *contractIdMArray,NSMutableArray *contractNameMArray,NSMutableArray *statusMArray){
