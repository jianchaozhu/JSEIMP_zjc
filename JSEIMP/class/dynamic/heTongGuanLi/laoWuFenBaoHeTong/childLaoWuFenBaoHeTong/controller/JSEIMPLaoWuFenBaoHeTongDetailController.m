//
//  JSEIMPLaoWuFenBaoHeTongDetailController.m
//  JSEIMP
//
...
#import "JSEIMPLaoWuFenBaoHeTongDetailController.h"
...
@interface JSEIMPLaoWuFenBaoHeTongDetailController ()<UIDocumentInteractionControllerDelegate>
...
@property(nonatomic,strong)NSString *baoZhengJinPayBack;
...
@implementation JSEIMPLaoWuFenBaoHeTongDetailController{
    ...
    JSEIMPCaiLiaoSheBeiView *_caiLiaoSheBeiView;
...
-(void)getData{
    ...
    NSLog(@"%@",_contractId);
    [JSEIMPNetWorking getLaoWuFenBaoHeTongDetailWithContractId:_contractId OnSuccess:^(NSString *contractCode,NSString *projectName,NSString *jiaFangName,NSString *yiFangName,NSString *diSanFangName,NSString *contractType,NSString *amount,NSString *finalQianYueDate,NSString *finalStartDate,NSString *finalEndDate,NSString *days,NSString *creator,NSString *chengBaoFanWei,NSString *qualityBiaoZhun,NSString *caiLiaoSheBei,NSString *fuKuanTiaoKuan,NSString *baoZhengJinPayBack,NSString *otherTiaoKuan,NSMutableArray *fileTypeMArray,NSMutableArray *fileNameMArray,NSMutableArray *filePathMArray){
        ...
        _startDate = finalStartDate.copy;
        _endDate = finalEndDate.copy;
        _days = days.copy;
        _creator = creator.copy;
        _qualityBiaoZhun = qualityBiaoZhun.copy;
        _chengBaoFanWei = chengBaoFanWei.copy;
        _caiLiaoSheBei = caiLiaoSheBei.copy;
        _fuKuanTiaoKuan = fuKuanTiaoKuan.copy;
        _baoZhengJinPayBack = baoZhengJinPayBack.copy;
...
-(void)setupUI{
    ...
    _label10 = [self setupLabelWithText:@"计划开工日期" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _label11 = [self setupLabelWithText:@"计划完成日期" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _label12 = [self setupLabelWithText:@"工期天数" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _label13 = [self setupLabelWithText:@"发起人" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    _label14 = [self setupLabelWithText:@"合同状态" TextColor:[UIColor darkTextColor] Font:[UIFont systemFontOfSize:20]];
    ...
    [_label14 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(_label12.mas_right);
    }];
...
-(void)setupCursor{
    ...
    _titles = [NSMutableArray arrayWithObjects:@"发包范围",@"质量标准",@"材料、设备供应",@"合同价款的支付",@"保证金交付退还",@"补充条款",@"附件", nil];
...
- (NSMutableArray *)createPageViews{
    ...
    for (NSInteger i = 0; i < self.titles.count; i++) {
        ...
        if (i == 0) {
            ...
            [_scrollView2 addSubview:_qualityBiaoZhunView];
            ...
            _caiLiaoSheBeiView = [[JSEIMPCaiLiaoSheBeiView alloc] init];
            //发送通知
            [[NSNotificationCenter defaultCenter] postNotificationName:@"caiLiaoSheBei" object:_caiLiaoSheBei];
            
            [_scrollView3 addSubview:_caiLiaoSheBeiView];
            
            [_caiLiaoSheBeiView mas_makeConstraints:^(MASConstraintMaker *make) {
                
                make.edges.mas_equalTo(_scrollView3);
                make.width.mas_equalTo(UIScreenW);
                make.bottom.mas_equalTo(_caiLiaoSheBeiView.caiLiaoSheBeiLabel.mas_bottom).offset(16);
            }];
            ...
            [_scrollView4 addSubview:_fuKuanTiaoKuanView];
            ...
            //发送通知
            [[NSNotificationCenter defaultCenter] postNotificationName:@"jiaoFuTuiHuan" object:_baoZhengJinPayBack];
            
            [_scrollView5 addSubview:_jiaoFuTuiHuanView];
