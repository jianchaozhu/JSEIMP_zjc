//
//  JSEIMPZhuanYeFenBaoHeTongController.m
//  JSEIMP
//
...
@interface JSEIMPZhuanYeFenBaoHeTongController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UIScrollViewDelegate>
...
@implementation JSEIMPZhuanYeFenBaoHeTongController{
...
-(void)getData{
    ...
    [JSEIMPNetWorking getZhuanYeFenBaoHeTongOnSuccess:^(NSMutableArray *contractIdMArray,NSMutableArray *contractNameMArray,NSMutableArray *statusMArray){
